...
if not st.session_state['auth']:
    ...
    elif pantalla == 'monitor_barreras_seguridad': vista_monitor_barreras_seguridad()
    elif pantalla == 'formulas': vista_formulas()
    elif pantalla == 'manual': vista_manual()
if not st.session_state['auth']: vista_registro()
